...
QT_MOC_LITERAL(1, 14, 6), // "opened"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 2), // "ok"
QT_MOC_LITERAL(4, 25, 7) // "message"

    },
    "CaptureThread\0opened\0\0ok\0message"
};
...
void CaptureThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->opened((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CaptureThread::*)(bool , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureThread::opened)) {
                *result = 0;
                return;
            }
        }
...
void *CaptureThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "FrameSource"))
        return static_cast< FrameSource*>(this);
...
// SIGNAL 0
void CaptureThread::opened(bool _t1, const QString & _t2)
{
